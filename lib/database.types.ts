...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      flow_execution_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "flow_execution_events_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      contact_fields: {
        ...
        Relationships: [
          {
            foreignKeyName: "contact_fields_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      fn_broadcast_materializar: {
        Args: { p_broadcast: string; p_contact_ids: string[]; p_org: string }
        Returns: Json
      }
      ...
      fn_claim_due_broadcast_recipients: {
        Args: { p_broadcast: string; p_lease_seconds: number; p_limit: number }
        Returns: {
          attempts: number
          broadcast_id: string
          claimed_until: string | null
