...
export const DICIONARIO: Traducoes = {
  ...
  "Conectar WhatsApp com Meta": { es: "Conectar WhatsApp con Meta" },
  "Você entra na sua conta da Meta, escolhe a conta do WhatsApp Business e o número, e o CRM guarda a autorização sozinho — sem copiar ID nem token.": { es: "Entras en tu cuenta de Meta, eliges la cuenta de WhatsApp Business y el número, y el CRM guarda la autorización solo — sin copiar ID ni token." },
  "Aguardando a Meta…": { es: "Esperando a Meta…" },
  "Reconectar com a Meta": { es: "Reconectar con Meta" },
  "O canal envia, mas o recebimento ainda não foi ativado — veja o aviso de webhook abaixo.": { es: "El canal envía, pero la recepción aún no se activó — mira el aviso de webhook abajo." },
  "Próximos passos na Meta: cadastre uma forma de pagamento no WhatsApp Manager. Se o número é novo, conclua o registro dele antes do primeiro envio.": { es: "Próximos pasos en Meta: registra un medio de pago en WhatsApp Manager. Si el número es nuevo, completa su registro antes del primer envío." },
  "A conexão foi cancelada antes de terminar. Nada foi alterado.": { es: "La conexión se canceló antes de terminar. No se cambió nada." },
  "Não foi possível carregar o login da Meta. Desative bloqueadores de anúncio ou de rastreamento para este site e recarregue a página.": { es: "No se pudo cargar el inicio de sesión de Meta. Desactiva los bloqueadores de anuncios o de rastreo para este sitio y recarga la página." },
  "A Meta interrompeu a conexão com um erro. Tente de novo; se persistir, confira a conta no Gerenciador de Negócios da Meta.": { es: "Meta interrumpió la conexión con un error. Intenta de nuevo; si persiste, revisa la cuenta en el Administrador comercial de Meta." },
  "Não foi possível falar com o CRM. Confira a conexão e tente de novo.": { es: "No se pudo hablar con el CRM. Revisa la conexión e intenta de nuevo." },
  "Esta opção ainda não está configurada nesta instalação. Defina no arquivo de instalação as variáveis abaixo e cadastre a chave secreta em Admin › API Oficial (Meta):": { es: "Esta opción aún no está configurada en esta instalación. Define en el archivo de instalación las variables de abajo y registra la clave secreta en Admin › API Oficial (Meta):" },
  "Esta opção ainda não está configurada nesta instalação. Peça a quem administra a instalação — enquanto isso, use a conexão manual abaixo.": { es: "Esta opción aún no está configurada en esta instalación. Pídelo a quien administra la instalación — mientras tanto, usa la conexión manual de abajo." },
  "Conexão manual / avançado": { es: "Conexión manual / avanzado" },
  "autorização vale até": { es: "autorización válida hasta" },
  "A conexão pela Meta não está configurada nesta instalação.": { es: "La conexión por Meta no está configurada en esta instalación." },
  "Muitas tentativas seguidas. Aguarde alguns minutos.": { es: "Demasiados intentos seguidos. Espera unos minutos." },
  "A instalação não consegue assinar a conexão agora.": { es: "La instalación no puede firmar la conexión ahora." },
  "Este número já está conectado em outra organização desta instalação.": { es: "Este número ya está conectado en otra organización de esta instalación." },
  "Pedido recusado: ele não veio da tela do CRM.": { es: "Solicitud rechazada: no vino de la pantalla del CRM." },
  "Pedido incompleto. Tente conectar de novo.": { es: "Solicitud incompleta. Intenta conectar de nuevo." },
  "A Meta não devolveu a autorização. Tente conectar de novo.": { es: "Meta no devolvió la autorización. Intenta conectar de nuevo." },
  "Esta conexão expirou ou foi aberta por outra pessoa ou organização. Comece de novo.": { es: "Esta conexión expiró o fue abierta por otra persona u organización. Empieza de nuevo." },
  "Esta autorização já foi usada. Comece a conexão de novo.": { es: "Esta autorización ya se usó. Empieza la conexión de nuevo." },
  "Não foi possível conferir a conexão agora. Tente de novo em instantes.": { es: "No se pudo verificar la conexión ahora. Intenta de nuevo en unos instantes." },
  "Este tipo de conexão ainda não é suportado. Use um número dedicado à API oficial, sem o aplicativo WhatsApp Business.": { es: "Este tipo de conexión aún no es compatible. Usa un número dedicado a la API oficial, sin la aplicación WhatsApp Business." },
  "A autorização da Meta expirou antes de chegar ao CRM. Tente conectar de novo.": { es: "La autorización de Meta expiró antes de llegar al CRM. Intenta conectar de nuevo." },
  "Esta autorização da Meta já foi usada. Tente conectar de novo.": { es: "Esta autorización de Meta ya se usó. Intenta conectar de nuevo." },
  "A Meta não aceitou a autorização. Tente conectar de novo.": { es: "Meta no aceptó la autorización. Intenta conectar de nuevo." },
  "A Meta recusou o aplicativo configurado nesta instalação. Quem administra a instalação precisa conferir o App ID e o App Secret.": { es: "Meta rechazó la aplicación configurada en esta instalación. Quien administra la instalación debe revisar el App ID y el App Secret." },
  "A Meta não respondeu agora. Tente de novo em alguns minutos.": { es: "Meta no respondió ahora. Intenta de nuevo en unos minutos." },
  "A Meta devolveu uma autorização que não vale. Tente conectar de novo.": { es: "Meta devolvió una autorización que no es válida. Intenta conectar de nuevo." },
  "A autorização pertence a outro aplicativo da Meta. Quem administra a instalação precisa conferir o App ID.": { es: "La autorización pertenece a otra aplicación de Meta. Quien administra la instalación debe revisar el App ID." },
  "Nenhuma conta do WhatsApp Business foi compartilhada na autorização. Refaça a conexão e selecione a conta.": { es: "No se compartió ninguna cuenta de WhatsApp Business en la autorización. Rehaz la conexión y selecciona la cuenta." },
  "Mais de uma conta do WhatsApp Business foi autorizada. Refaça a conexão escolhendo só uma.": { es: "Se autorizó más de una cuenta de WhatsApp Business. Rehaz la conexión eligiendo solo una." },
  "A conta do WhatsApp Business indicada não foi autorizada para este CRM. Refaça a conexão.": { es: "La cuenta de WhatsApp Business indicada no fue autorizada para este CRM. Rehaz la conexión." },
  "A conta do WhatsApp Business não tem número. Adicione um número no WhatsApp Manager e conecte de novo.": { es: "La cuenta de WhatsApp Business no tiene número. Agrega un número en WhatsApp Manager y conecta de nuevo." },
  "A conta tem mais de um número. Refaça a conexão escolhendo o número.": { es: "La cuenta tiene más de un número. Rehaz la conexión eligiendo el número." },
  "O número indicado não pertence à conta autorizada. Refaça a conexão.": { es: "El número indicado no pertenece a la cuenta autorizada. Rehaz la conexión." },
  "A Meta não confirmou o número com esta autorização. Tente conectar de novo.": { es: "Meta no confirmó el número con esta autorización. Intenta conectar de nuevo." },
  "Não foi possível gravar a conexão. Tente de novo.": { es: "No se pudo guardar la conexión. Intenta de nuevo." },
  "provedor parceiro": { es: "proveedor asociado" },
  ...
  //
  // As telas de automação (migrations 0388 e 0389). A chave continua sendo o
  ...
  //
  // As três descrições de menu abaixo são cobradas por
  // `tests/unit/i18n-catalogo-do-menu.test.ts`: o catálogo de navegação é lido
  // por `t()` com a descrição literal de `lib/navigation/catalogo.ts`.
  "Monte o caminho do contato numa tela: escolha o gatilho e ligue mensagens, ações, esperas e condições.":
    { es: "Arme el recorrido del contacto en una pantalla: elija el disparador y conecte mensajes, acciones, esperas y condiciones." },
  "Envie WhatsApp em massa para um público filtrado por tag e por campo, com agendamento e acompanhamento.":
    { es: "Envíe WhatsApp masivo a un público filtrado por etiqueta y por campo, con programación y seguimiento." },
  "Os campos personalizados do contato: nome, tipo, pasta e o identificador que a API e o N8N usam.":
    { es: "Los campos personalizados del contacto: nombre, tipo, carpeta y el identificador que usan la API y N8N." },
  // Motivos de parada das ações de automação visual (`MOTIVO_DA_PARADA`, aba
  // Atividade) — cobrados por `tests/unit/motivo-de-parada-tem-frase.test.ts`.
  "Esta ação não tem um fluxo escolhido. Abra a automação e escolha qual fluxo iniciar.":
    { es: "Esta acción no tiene un flujo elegido. Abra la automatización y elija qué flujo iniciar." },
  "O fluxo escolhido não existe mais nesta organização. Abra a automação e escolha outro fluxo.":
    { es: "El flujo elegido ya no existe en esta organización. Abra la automatización y elija otro flujo." },
  "O fluxo escolhido está desativado, então não foi iniciado. Ative o fluxo ou escolha outro.":
    { es: "El flujo elegido está desactivado, por eso no se inició. Active el flujo o elija otro." },
  "Esta ação não tem um campo escolhido. Abra a automação e escolha qual campo alterar.":
    { es: "Esta acción no tiene un campo elegido. Abra la automatización y elija qué campo modificar." },
  "Esta ação não tem uma pessoa escolhida para receber a conversa. Abra a automação e escolha um atendente.":
    { es: "Esta acción no tiene una persona elegida para recibir la conversación. Abra la automatización y elija un agente." },
  "O contato ainda não tem conversa, então não havia o que abrir ou atribuir.":
    { es: "El contacto todavía no tiene conversación, así que no había nada que abrir o asignar." },
