...
const MOTIVO_DA_PARADA: Record<string, string> = {
  ...
  flow_inactive: "O fluxo escolhido está desativado, então não foi iniciado. Ative o fluxo ou escolha outro.",
  missing_field: "Esta ação não tem um campo escolhido. Abra a automação e escolha qual campo alterar.",
  missing_user_id:
    "Esta ação não tem uma pessoa escolhida para receber a conversa. Abra a automação e escolha um atendente.",
  no_conversation: "O contato ainda não tem conversa, então não havia o que abrir ou atribuir.",
  fora_do_pre_go_live:
