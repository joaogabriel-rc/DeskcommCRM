...
/**
 * 0399 · O DISPARO COM FLUXO, no banco que o CLONE recebe (`supabase/baseline.sql`).
 *
...
const A = "0399aaaa-0000-4000-8000-000000000001";
const B = "0399bbbb-0000-4000-8000-000000000002";
const MEMBRO_B = "0399bbbb-1111-4000-8000-000000000002";
const CONTATO_A = "0399aaaa-2222-4000-8000-000000000001";
const CONTATO_A2 = "0399aaaa-2222-4000-8000-000000000002";
const DISPARO_A = "0399aaaa-3333-4000-8000-000000000001";
const DISPARO_A2 = "0399aaaa-3333-4000-8000-000000000002";
const DISPARO_B = "0399bbbb-3333-4000-8000-000000000001";
const FLUXO_A = "0399aaaa-4444-4000-8000-000000000001";
const FLUXO_A2 = "0399aaaa-4444-4000-8000-000000000002";
const DEST_A = "0399aaaa-5555-4000-8000-000000000001";
const DEST_A2 = "0399aaaa-5555-4000-8000-000000000002";
const SESSAO_B = "0399bbbb-6666-4000-8000-000000000001";
...
function seed(): void {
  sql(`
    insert into auth.users (id, email) values ('${MEMBRO_B}', 'membro-b-0399@invariant.test') on conflict do nothing;
    insert into public.organizations (id, slug, legal_name, display_name) values
      ('${A}', 'inv-0399-a', 'Disparo A', 'Disparo A'),
      ('${B}', 'inv-0399-b', 'Disparo B', 'Disparo B')
...
describe("0399 · o fluxo do disparo", () => {
  ...
  it("fluxo de OUTRA organização não aponta para o disparo desta (FK composta)", () => {
    ...
    sql(`insert into public.broadcasts (id, organization_id, name)
           values ('0399aaaa-3333-4000-8000-0000000000ee', '${A}', 'sem fluxo') on conflict do nothing;`);
    expect(
      erroDe(() =>
        sql(`insert into public.flows (organization_id, name, trigger_type, broadcast_id)
               values ('${B}', 'intruso', 'broadcast', '0399aaaa-3333-4000-8000-0000000000ee');`),
      ),
  ...
  it("apagar o disparo leva o fluxo dele junto", () => {
    sql(`insert into public.broadcasts (id, organization_id, name) values ('0399aaaa-3333-4000-8000-0000000000ff', '${A}', 'efêmero');
         insert into public.flows (id, organization_id, name, trigger_type, broadcast_id)
           values ('0399aaaa-4444-4000-8000-0000000000ff', '${A}', 'efêmero', 'broadcast', '0399aaaa-3333-4000-8000-0000000000ff');
         delete from public.broadcasts where id = '0399aaaa-3333-4000-8000-0000000000ff';`);
    expect(sql(`select count(*) from public.flows where id = '0399aaaa-4444-4000-8000-0000000000ff'`)).toBe("0");
  });
});

describe("0399 · a execução iniciada pelo disparo", () => {
  ...
  it("controle: execução COMUM (sem destinatário) segue como sempre", () => {
    sql(`insert into public.flows (id, organization_id, name, trigger_type)
           values ('0399aaaa-4444-4000-8000-0000000000aa', '${A}', 'comum', 'contact_created') on conflict do nothing;
         insert into public.flow_executions (organization_id, flow_id, contact_id)
           values ('${A}', '0399aaaa-4444-4000-8000-0000000000aa', '${CONTATO_A2}');`);
    expect(sql(`select count(*) from public.flow_executions where flow_id = '0399aaaa-4444-4000-8000-0000000000aa'`)).toBe("1");
  });
});

describe("0399 · materialização e RLS", () => {
  it("materializar com número de OUTRA organização é recusado dentro do definer", () => {
    sql(`insert into public.channel_sessions (id, organization_id, provider, meta_phone_number_id, webhook_secret_encrypted)
           values ('${SESSAO_B}', '${B}', 'meta_cloud', 'pn-0399-b', '\\x00'::bytea) on conflict do nothing;`);
    expect(
      erroDe(() =>
